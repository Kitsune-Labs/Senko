						...
						components: [
							{
								type: 1,
								components: [
									{ type: 2, label: "Home", style: 1, customId: "help:home", disabled: true },
						...
						components: [
							{
								type: 1,
								components: [
									{ type: 2, label: "Home", style: 4, customId: "help:home", disabled: false },
									{ type: 2, label: "Fun", style: 1, customId: "help:fun", disabled: true },
									{ type: 2, label: "Economy", style: 3, customId: "help:economy", disabled: false },
									{ type: 2, label: "Administration", style: 3, customId: "help:admin", disabled: false },
									{ type: 2, label: "Account", style: 3, customId: "help:account", disabled: false }
								]
							},
							{
						...
						components: [
							{
								...
								components: [
									{ type: 2, label: "Home", style: 4, customId: "help:home", disabled: false },
									{ type: 2, label: "Fun", style: 3, customId: "help:fun", disabled: false },
									{ type: 2, label: "Economy", style: 1, customId: "help:economy", disabled: true },
									{ type: 2, label: "Administration", style: 3, customId: "help:admin", disabled: false },
									{ type: 2, label: "Account", style: 3, customId: "help:account", disabled: false }
								]
							},
						...
						components: [
							{
								...
								components: [
									...
									{ type: 2, label: "Fun", style: 3, customId: "help:fun", disabled: false },
									{ type: 2, label: "Economy", style: 3, customId: "help:economy", disabled: false },
									{ type: 2, label: "Administration", style: 1, customId: "help:admin", disabled: true },
									{ type: 2, label: "Account", style: 3, customId: "help:account", disabled: false }
								]
							},
							{
						...
						components: [
							{
								...
								components: [
									...
									{ type: 2, label: "Economy", style: 3, customId: "help:economy", disabled: false },
									{ type: 2, label: "Administration", style: 3, customId: "help:admin", disabled: false },
									{ type: 2, label: "Account", style: 1, customId: "help:account", disabled: true }
								]
							},
							{
								type: 1,
					...
					interaction.update({
						...
						components: [
							...
							},
							{
								type: 1,
								components: [
									{ type: 2, label: "Utility", style: 1, customId: "help:utility", disabled: true }
								]
							},
							bottomButtons
						]
