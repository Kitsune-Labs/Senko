...
const { Client, ButtonStyle, ComponentType, ChannelType } = require("discord.js");
const { randomArray } = require("../API/Master");
const { updateSuperGuild, updateSuperUser, fetchSuperUser, fetchMarket, fetchSuperGuild } = require("../API/super");
