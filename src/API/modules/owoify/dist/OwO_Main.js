...
var uvuMappingArray = [Map_O_To_OwO, Map_Ew_To_UwU, Map_N_Vowel_T_To_Nd];
var uwuMappingArray = [Map_PeriodCommaExclamationSemicolon_To_Kaomojis, Map_That_To_Dat, Map_Th_To_F, Map_Le_To_Wal, Map_Ve_To_We, Map_Ry_To_Wwy, Map_ROrL_To_W];
