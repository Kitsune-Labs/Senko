...
module.exports = {
     ...
     */
    hasPerm(interaction, Permission) {
     ...
     */
    selfPerm(interaction, Permission, ClientID) {
     ...
     * @param {User} User
     */
    async CheckPermission(interaction, Permission, User) {
